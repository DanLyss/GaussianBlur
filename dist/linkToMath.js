export class LinkToMath {
    ...
    requestedStart(blurRadius, UIcall, //optional for now
    timePeriod = 50) {
        ...
        return new Promise(resolve => {
            ...
            this.worker.onmessage = (e) => {
                ...
                if (msg.type === "finished") {
                    this.isProcessStarted = false;
                    this.processedImageData = new ImageData(new Uint8ClampedArray(msg.resultImage), this.imageData.width, this.imageData.height);
                    this.postImageInit();
                    resolve(true);
                }
            };
